...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def damen_click(self):
        ...
        #Wettbewerb 2
        WettbewerbHaspa = "KK Preisschiessen KK"
        discHaspa = "KK"
        zielteilerHaspa = 380
        dataHaspa = pd.read_csv('backup/full.csv', index_col=0)
        print('check')
        self.ui.HaspaTable.setRowCount(0)
        resHaspa = bf.Teiler_One(dataHaspa,zielteilerHaspa,WettbewerbHaspa,discHaspa)
